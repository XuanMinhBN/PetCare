...
function CreateCatProfile({ onNavigate, onBack }) {
  ...
  const catBreeds = [
    { id: "British Shorthair", name: "Mèo Anh lông ngắn", image: "🐱" },
    { id: "Persian", name: "Mèo Ba Tư", image: "🐱" },
    { id: "Maine Coon", name: "Maine Coon", image: "🐱" },
    { id: "Ragdoll", name: "Ragdoll", image: "🐱" },
    { id: "Siamese", name: "Mèo Xiêm", image: "🐱" },
    { id: "American Shorthair", name: "Mèo Mỹ lông ngắn", image: "🐱" },
    { id: "Scottish Fold", name: "Mèo tai cụp", image: "🐱" },
    { id: "Russian Blue", name: "Mèo Nga xanh", image: "🐱" },
    { id: "Bengal", name: "Mèo Bengal", image: "🐱" },
    { id: "Sphynx", name: "Mèo không lông", image: "🐱" },
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.success) {
        alert("Tạo hồ sơ mèo thành công!");
        onBack();
      } else {
        setError(result.error || "Tạo hồ sơ mèo thất bại");
      }
    } catch (err) {
      setError("Có lỗi xảy ra khi tạo hồ sơ mèo");
    } finally {
      setSaving(false);
    }
  };
