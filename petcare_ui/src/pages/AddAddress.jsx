...
function AddAddress({ onNavigate, onBack }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await profileAPI.addAddress(formData);
      if (result.success) {
        alert("Địa chỉ đã được thêm thành công!");
        onBack();
      } else {
        setError(result.error || "Thêm địa chỉ thất bại");
      }
    } catch (err) {
      setError("Có lỗi xảy ra khi thêm địa chỉ");
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-green-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between p-4">
          ...
          <div className="text-white font-bold text-xl">Thêm địa chỉ</div>
